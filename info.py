...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002440330128').split()]
...
auth_channel = environ.get('-1002440330128')
auth_grp = environ.get('-1002246548930')
